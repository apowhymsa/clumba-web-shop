                        ...
                        {fields.map((item, index) => (<li key={item.id} className="flex flex-col gap-y-4">
                            <div className="flex gap-x-4 items-center">
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="relative">
                                        <input
                                            className={`block w-full h-8 text-sm rounded-md shadow-sm pl-4 ${errors.variants?.at?.(index)?.vType ? "border-red-300 focus:border-red-300 focus:ring focus:ring-red-200" : "border-gray-300 focus:border-blue-300 focus:ring focus:ring-blue-200"}  focus:ring-opacity-50 disabled:cursor-not-allowed disabled:bg-gray-50 disabled:text-gray-500`}
