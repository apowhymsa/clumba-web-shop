...
const Button: FC<Props> = (props) => {
    ...
    const className = useMemo(() => clsx('w-full text-sm items-center justify-center h-10 px-4 rounded border border-rose-400 transition-colors disabled:cursor-not-allowed',
