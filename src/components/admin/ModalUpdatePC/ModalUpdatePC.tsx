  ...
  return (
    <>
      <div className="flex items-center justify-between px-6 py-3 border-b">
        <div className="font-bold text-lg">Редагування категорії товарів</div>
        <div
            ...
            <>
              <div>
                ...
                <div className="relative">
                  <input
                    className={`block w-full text-sm h-8 rounded-md shadow-sm pl-4 ${
                      errors.categoryName
              ...
              <Button
                type="submit"
                variant="primary"
                content={isLoadingUpdate ? <Loader /> : "Оновити"}
